...
export default function Stats() {
  ...
  return (
    <section ref={statsRef} className="w-full py-12 md:py-24 bg-[#172737] text-white">
      <div className="w-full px-8 md:px-16 lg:px-24 xl:px-32">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="space-y-2 stat-item">
            <h3 className="text-4xl font-bold text-[#5ebc66]">500+</h3>
            <p className="text-sm text-[#c5ddca]">Clients Served</p>
          </div>
          <div className="space-y-2 stat-item">
            <h3 className="text-4xl font-bold text-[#5ebc66]">1,000+</h3>
            <p className="text-sm text-[#c5ddca]">Projects Completed</p>
          </div>
          <div className="space-y-2 stat-item">
            <h3 className="text-4xl font-bold text-[#5ebc66]">50+</h3>
            <p className="text-sm text-[#c5ddca]">IT Experts</p>
          </div>
          <div className="space-y-2 stat-item">
            <h3 className="text-4xl font-bold text-[#5ebc66]">10+</h3>
